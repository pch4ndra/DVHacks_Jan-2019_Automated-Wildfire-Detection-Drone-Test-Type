...
void loop() {
  ...
  { 
    ...
    // Trackuino Loop Function
      // Time for another APRS frame
      if ((int32_t) (millis() - next_aprs) >= 0) {
        
        // Get a valid position from the GPS (get_pos)
        int valid_pos = 0;
        ...
        ax25_send_string("/Temp=");
        snprintf(temp, 4, "%03d", (int)(DHT.temperature));
        ax25_send_string(temp);
        ax25_send_string("/Smoke=");
        snprintf(temp, 4, "%03d", (int)(analogSmokeSensor));
